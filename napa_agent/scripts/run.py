...
from napa_agent.pipelines.shareholders import run_shareholders_pipeline
...
def main() -> None:
    ...
    scheduler.add_job(run_shareholders_pipeline, "cron", hour=7, minute=20, args=[engine, settings], id="shareholders")
